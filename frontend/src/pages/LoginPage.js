    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1758208974170-3a3037da0c69?crop=entropy&cs=srgb&fm=jpg&q=85')` }}
        />
        <div className="relative z-10 flex flex-col justify-between p-12 text-primary-foreground">
          ...
          <div>
            ...
            >
              Track progress.<br />Hit deadlines.<br />Ship faster.
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              The project tracking tool built for developers who value clarity and speed.
            </motion.p>
          </div>
          <p className="text-sm opacity-60">Made for portfolio showcase</p>
        </div>
      </div>
